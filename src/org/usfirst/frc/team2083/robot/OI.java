...
public class OI {
    ...
    public OI() {
        ...
        buttonA.whenPressed(new ButtonCommandSlowDown());
        buttonB.whenPressed(new ButtonCommandEmergencyStop());
        buttonX.whenPressed(new ButtonCommandStandardSpeed());
        buttonY.whenPressed(new ButtonCommandTurboSpeed());
    }
